 ...
 */
define('GENFORM_VERSION', '1.3.0');
define('GENFORM_PATH', plugin_dir_path(__FILE__));
define('GENFORM_URL', plugin_dir_url(__FILE__));

/**
 * Freemius SDK — deferred to a future release.
 * The SDK files remain in vendor/freemius/ for when we
 * re-enable licensing and in-dashboard upgrades.
 */
