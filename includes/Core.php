...
final class Core
{
	...
	private function init(): void
	{
		...
		add_action('admin_footer', [$this, 'outputGlobalModals']);
...
?>
	...
	public function registerMenus(): void
	{
		...
		add_submenu_page('genform', esc_html__('All Forms', 'genform'), esc_html__('All Forms', 'genform'), 'manage_options', 'genform', [$this, 'renderFormsList']);
		add_submenu_page('genform', esc_html__('Add New', 'genform'), esc_html__('Add New', 'genform'), 'manage_options', 'genform-builder', [Builder::class, 'render']);
		add_submenu_page('genform', esc_html__('Entries', 'genform'), esc_html__('Entries', 'genform'), 'manage_options', 'genform-entries', [$this, 'renderEntries']);
		add_submenu_page('genform', esc_html__('Settings', 'genform'), esc_html__('Settings', 'genform'), 'manage_options', 'genform-settings', [Settings::class, 'render']);

		// Hidden pages (no menu items).
		add_submenu_page(null, esc_html__('Form Preview', 'genform'), '', 'manage_options', 'genform-preview', [$this, 'renderPreview']);
		add_submenu_page(null, esc_html__('Entry Detail', 'genform'), '', 'manage_options', 'genform-entry-detail', [$this, 'renderEntryDetail']);
	}
...
<?php
	...
	public function enqueueAdminAssets(string $hook): void
	{
		...
		foreach ($forms as $form_item) {
			$block_options[] = ['label' => $form_item->form_name, 'value' => (int) $form_item->id];
		}
